            ...
            <div>
              ...
              <div className="relative flex items-center">
                <Input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 dark:bg-petflix-dark-gray dark:border-gray-600 dark:text-white focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
