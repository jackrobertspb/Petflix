          ...
          <form onSubmit={handleCreatePlaylist}>
            <div className="mb-4">
              ...
              <Input
                ...
                className="w-full px-4 py-3 bg-gray-100 dark:bg-petflix-dark-gray text-charcoal dark:text-white border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
            ...
            <div className="mb-4">
              ...
              <Textarea
                ...
                className="w-full px-4 py-3 bg-gray-100 dark:bg-petflix-gray text-charcoal dark:text-white focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange resize-none border border-gray-300 dark:border-transparent"
