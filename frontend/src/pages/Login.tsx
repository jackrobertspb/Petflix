        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          ...
          <div className="relative flex items-center">
            <Input
              ...
              className="w-full px-5 py-4 pr-12 bg-gray-100 dark:bg-petflix-gray text-charcoal dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
