        ...
        <div className="bg-white dark:bg-petflix-dark rounded-lg p-8 border border-gray-200 dark:border-transparent">
          {loading && status === 'verifying' ? (
            <div className="text-center">
              <div className="inline-block animate-spin rounded-full h-12 w-12 border-4 border-lightblue dark:border-petflix-orange border-t-transparent mb-4"></div>
            ...
            <div className="text-center">
              ...
              <Link
                to="/settings"
                className="inline-block px-6 py-3 bg-lightblue hover:bg-lightblue/80 dark:bg-petflix-orange dark:hover:bg-petflix-red text-charcoal dark:text-white font-bold rounded-lg transition"
              >
                Go to Settings
              </Link>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Link
                  to="/settings"
                  className="block px-6 py-3 bg-lightblue hover:bg-lightblue/80 dark:bg-petflix-orange dark:hover:bg-petflix-red text-charcoal dark:text-white font-bold rounded-lg transition text-center"
                >
                  Go to Settings
                </Link>
                <Link
