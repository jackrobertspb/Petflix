  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-cream-light dark:bg-petflix-black pt-20 sm:pt-24 px-4 sm:px-6 md:px-8 lg:px-16">
      <div className="max-w-5xl mx-auto mb-8 sm:mb-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-charcoal dark:text-white mb-4 sm:mb-6 md:mb-8">
          Search Pet Videos 🔍
        </h1>
        ...
        <form onSubmit={handleSearch}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-4 sm:mb-6">
            <div className="flex-1 relative">
              <div className="flex items-center bg-white dark:bg-petflix-dark-gray rounded-lg border border-gray-300 dark:border-gray-700 shadow-sm focus-within:ring-2 focus-within:ring-lightblue dark:focus-within:ring-petflix-orange">
                ...
                <Input
                  ...
                  className="flex-1 px-6 py-4 bg-transparent border-0 text-charcoal dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus-visible:ring-0 focus-visible:ring-offset-0 text-base shadow-none"
                />
              </div>
            </div>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="px-6 sm:px-10 py-3 sm:py-4 bg-lightblue hover:bg-blue-400 dark:bg-petflix-orange dark:hover:bg-orange-500 text-white font-semibold shadow-md hover:shadow-lg text-sm sm:text-base"
            >
