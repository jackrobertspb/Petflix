...
export const Profile = () => {
  ...
  if (error || !profileUser) {
    return (
      <div className="min-h-screen bg-petflix-black flex items-center justify-center pt-24 px-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-petflix-dark rounded-lg p-8 mb-8">
          <div className="flex items-start gap-6">
            <div className="w-32 h-32 rounded-full bg-petflix-gray flex items-center justify-center text-6xl flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-6 mb-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">{followStats.followersCount}</div>
                  <div className="text-sm text-gray-400">Followers</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">{followStats.followingCount}</div>
              ...
              <div className="flex gap-4">
                {currentUser && !isOwnProfile && (
                  <button
                    ...
                    className={`px-6 py-3 font-bold rounded transition ${
                      isFollowing
                        ? 'bg-petflix-gray text-white hover:bg-opacity-80'
                        : 'bg-petflix-orange text-white hover:bg-petflix-red'
                    }`}
                  >
                ...
                {isOwnProfile && (
                  <Link
                    to="/settings"
                    className="px-6 py-3 bg-petflix-gray text-white font-bold rounded hover:bg-opacity-80 transition"
                  >
                    Edit Profile
                  </Link>
                )}
