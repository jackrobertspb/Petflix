...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-petflix-black flex items-center justify-center px-4 pt-20">
      <div className="max-w-md w-full bg-black/75 rounded-lg p-16 backdrop-blur-sm">
        <h1 className="text-4xl font-bold text-white mb-8">
          Join Petflix 🐾
        </h1>

        {error && (
          <div className="bg-petflix-orange/90 text-white px-4 py-3 rounded mb-6 text-sm">
            {error}
          </div>
        )}
