        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <Input
              ...
              className="w-full px-5 py-4 bg-gray-100 dark:bg-petflix-dark-gray text-charcoal dark:text-white border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
          ...
          <div>
            <div className="relative flex items-center">
              <Input
                ...
                className="w-full px-5 py-4 pr-12 bg-gray-100 dark:bg-petflix-dark-gray text-charcoal dark:text-white border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
          ...
          <div className="relative flex items-center">
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="absolute right-4 text-gray-400 hover:text-white disabled:opacity-30 disabled:hover:text-gray-400"
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full bg-lightblue hover:bg-lightblue/80 dark:bg-petflix-orange dark:hover:bg-petflix-red text-charcoal dark:text-white font-bold py-4"
          >
