        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-petflix-dark rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex gap-3">
              <Input
                ...
                className="flex-1 px-5 py-3 bg-white dark:bg-petflix-dark-gray text-charcoal dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border border-gray-300 dark:border-gray-600 dark:border-gray-700 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
              ...
              <Button
                ...
                className="px-6 py-3 bg-lightblue hover:bg-lightblue/80 dark:bg-petflix-gray dark:hover:bg-petflix-orange text-charcoal dark:text-white font-medium"
              >
                Preview
              </Button>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-petflix-dark rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <Input
              ...
              className="w-full px-5 py-3 bg-white dark:bg-petflix-dark-gray text-charcoal dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border border-gray-300 dark:border-gray-600 dark:border-gray-700 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange"
          ...
          <div className="bg-gray-50 dark:bg-petflix-dark rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <Textarea
              ...
              className="w-full px-5 py-3 bg-white dark:bg-petflix-dark-gray text-charcoal dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border border-gray-300 dark:border-gray-600 dark:border-gray-700 focus:ring-2 focus:ring-lightblue dark:focus:ring-petflix-orange resize-none"
          ...
          <div className="flex gap-4">
            <Button
              ...
              className="flex-1 bg-lightblue hover:bg-lightblue/80 dark:bg-petflix-orange dark:hover:bg-petflix-red text-charcoal dark:text-white font-bold py-4 text-lg"
            >
